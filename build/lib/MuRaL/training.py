...
def train(config, args, checkpoint_dir=None):
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            ...
            #print(f"Training Loss from LossTracker: {total_loss_tracker.report_mean_losses()}")
            # BUG: Tensor need convert to numpy before report_mean_losses
            # if local_loss_tracker.stored_losses:
            #     print(f"Training Local Loss from LossTracker: {local_loss_tracker.report_mean_losses()}")
            # if distal_loss_tracker.stored_losses:
            #     print(f"Training Distal Loss from LossTracker: {distal_loss_tracker.report_mean_losses()}")
