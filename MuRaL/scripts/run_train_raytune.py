...
def parse_arguments(parser):
    ...
    model_args.add_argument('--use_single_base_task', 
                            nargs='?',
                            const=True,
                            default=False,
                            help=textwrap.dedent("""
    ...
    model_args.add_argument('--distal_encoding', 
                            type=str,
                            default=None)
    ...
    model_args.add_argument('--avg_mut_dropout', type=float, metavar='FLOAT', default=[0.1], nargs='+', 
                          help=textwrap.dedent("""
                          Dropout rate for inputs of local hidden layers.  Default: 0.1.""" ).strip())
...
#                          """ ).strip())
    ...
    learn_args.add_argument('--LR_gamma', type=float, metavar='FLOAT', default=[0.9], nargs='+', 
                          ...
                          'gamma' argument for the learning rate scheduler.
                           Default: 0.9.
                           """ ).strip())
    learn_args.add_argument('--mix_loss', type=str, metavar='STR', default=None, 
                          help=textwrap.dedent("""
                          use mixed loss.
                           Default: None.
                           """ ).strip())
...
def main():
    ...
    * Output data
    ...
    avg_mut_dropout = args.avg_mut_dropout
    ...
    if not use_ray:
        ...
        'avg_mut_dropout': avg_mut_dropout[0],
    ...
    config = {
        ...
        'avg_mut_dropout': tune.choice(avg_mut_dropout),
