...
def train(config, args, checkpoint_dir=None):
    ...
    model_local = model_chocie_local()
    model_middle = model_choice_middle()
    model_large = model_choice_large() 
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            ...
            if construct_loss_tracker.stored_losses:
                print(f"construct Loss from LossTracker: {construct_loss_tracker.report_total_losses()/train_size}")
